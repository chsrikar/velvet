...
export default defineConfig({
  ...
  shortcuts: {
    ...
    'btn-primary': 'px-5 py-2.5 rounded-full bg-gradient-to-r from-blush to-lavender text-dark1 font-semibold cursor-pointer border-none transition-all duration-300 clay-btn hover:(shadow-lg scale-105)',
    'btn-outline': 'px-5 py-2.5 rounded-full border-2 border-blush bg-transparent text-dark1 font-semibold cursor-pointer transition-all duration-300 clay-btn hover:(bg-blush/20)',
